          ...
          <Row gutter={24}>
            ...
            <Col span={12}>
              ...
              <Form.Item label="Description" name="description" rules={[{ required: true, message: "Please enter a description!" }]}>
                <TextArea size="large" placeholder="Enter car description..." autoSize={{ minRows: 4, maxRows: 6 }} />
              </Form.Item>
            </Col>
            ...
            <Col span={12}>
              ...
              <Form.Item label="Daily Rental Price (Dollar)" name="price" rules={[{ required: true, message: "Please enter rental price!" }]}>
                <InputNumber size="large" min={1} step={10} style={{ width: "100%" }} formatter={(value) => `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ",")} />
              </Form.Item>
