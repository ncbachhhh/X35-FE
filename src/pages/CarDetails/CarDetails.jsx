      ...
      <div className="car-detail-image">
        <div className="car-image-container">
          ...
          <div className="car-mini-image">
            {images.map((image) => (
              <img key={image.id} src={image.url} onClick={() => setMainImage(image.url)} style={{ border: mainImage === image.url ? "2px solid #3563E9" : "1px solid transparent", borderRadius: "15px", objectFit: "cover", width: "calc(100% / 3)" }} />
            ))}
          </div>
        </div>
